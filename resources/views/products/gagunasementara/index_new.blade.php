...
@section('header')
<!-- Hero Section -->
<div class="hero-section bg-cover bg-center h-80 flex items-center" style="background-image: url('https://images.unsplash.com/photo-1541123437800-1bb1317badc2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80');">
    <div class="hero-overlay absolute inset-0"></div>
    <div class="container mx-auto px-6 relative z-10">
        <div class="max-w-lg">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-4 hero-text">Katalog Produk</h1>
            <p class="text-xl text-white mb-8 opacity-90">Temukan berbagai material konstruksi berkualitas untuk proyek Anda</p>
            <div class="flex space-x-4">
                <a href="#product-catalog" class="bg-[#99765c] hover:bg-[#876754] text-white font-bold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 inline-flex items-center">
                    Jelajahi Produk
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M16.707 10.293a1 1 0 010 1.414l-6 6a1 1 0 01-1.414 0l-6-6a1 1 0 111.414-1.414L9 14.586V3a1 1 0 012 0v11.586l4.293-4.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    </svg>
                </a>
                <a href="{{ route('quote-request.create') }}" class="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#99765c] font-bold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
                    Minta Penawaran
                </a>
            </div>
        </div>
            ...
            <div class="bg-white filter-container p-6 shadow-lg">
                ...
                <form action="{{ route('products.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            <select name="category" id="category" class="w-full border-gray-300 rounded-lg py-3 px-4 bg-white shadow-sm focus:border-[#99765c] focus:ring focus:ring-[#99765c] focus:ring-opacity-50 appearance-none search-input">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="search" id="search" value="{{ request('search') }}" placeholder="Nama produk..." class="w-full border-gray-300 rounded-lg py-3 px-4 shadow-sm focus:border-[#99765c] focus:ring focus:ring-[#99765c] focus:ring-opacity-50 search-input">
                    ...
                    <div class="flex items-end space-x-3">
                        <button type="submit" class="bg-[#99765c] hover:bg-[#876754] text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline transition duration-300 filter-button flex-grow md:flex-grow-0">
                        ...
                        @if(request('category') || request('search'))
                            <a href="{{ route('products.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline transition duration-300 filter-button flex-grow md:flex-grow-0">
                                <span class="flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @empty
                    <div class="col-span-3 py-16 text-center bg-white rounded-xl shadow-sm">
                        ...
                        <a href="{{ route('products.index') }}" class="bg-[#99765c] hover:bg-[#876754] text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline transition duration-300 inline-flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clip-rule="evenodd" />
                            </svg>
                            Lihat Semua Produk
