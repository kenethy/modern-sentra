        ...
        <div class="contact-hero mb-10 fade-in">
            <div class="py-10 px-6 md:py-12 md:px-10 text-center">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="#contact-form"
                        class="inline-flex items-center px-5 py-2 bg-white text-[#99765c] font-medium rounded-md hover:bg-gray-100 transition duration-300">
                    ...
                    <a href="#location"
                        class="inline-flex items-center px-5 py-2 bg-transparent border border-white text-white font-medium rounded-md hover:bg-white hover:text-[#99765c] transition duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div id="contact-form" class="fade-in delay-1 contact-column">
                <div class="form-container bg-white p-6 rounded-md shadow-sm">
                    ...
                    <form id="contactForm" action="#" method="POST" class="flex-grow flex flex-col">
                        ...
                        <div class="mt-auto">
                            <button type="submit"
                                class="submit-button bg-[#99765c] hover:bg-[#876754] text-white font-medium py-2 px-4 rounded-md transition duration-300">
                                Kirim Pesan
                            </button>
                        </div>
                    </form>
            ...
            <div id="location" class="fade-in delay-2 contact-column">
                ...
                <div class="mt-4 bg-white p-5 rounded-md shadow-sm flex-grow">
                    <h3 class="text-2xl font-bold text-gray-800 mb-6">Cara Mencapai Kami</h3>
