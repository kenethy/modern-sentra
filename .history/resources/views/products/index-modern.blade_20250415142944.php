...
<div class="bg-slate-100 py-12 px-4 sm:px-6 lg:px-8"> {{-- Lighter page background --}}
    <div class="max-w-7xl mx-auto">
        {{-- Hero Section --}}
        <div
            class="mb-12 rounded-lg overflow-hidden shadow-xl fade-in bg-gradient-to-r from-[var(--pro-primary)] to-[var(--pro-primary-light)]">
            {{-- Professional gradient --}}
            <div class="py-16 px-8 md:py-24 md:px-12 text-center md:text-left">
                <h1 style="color:white" class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 max-w-3xl drop-shadow-md">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#products"
                        class="inline-flex items-center px-6 py-3 bg-[var(--brand-color)] text-white font-medium rounded-lg shadow-md hover:bg-[var(--brand-color-dark)] transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)] focus:ring-offset-2">
                        Lihat Katalog
                    ...
                    <a href="{{ route('quote-request.create') }}"
                        class="inline-flex items-center px-6 py-3 bg-[var(--pro-accent)] hover:bg-[var(--pro-accent-dark)] text-white font-medium rounded-lg shadow-md transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[var(--pro-accent)] focus:ring-offset-2">
