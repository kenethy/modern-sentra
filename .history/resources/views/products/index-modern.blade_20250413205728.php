                ...
                <div class="p-6 sm:p-8 md:p-10 flex flex-col md:flex-row items-center justify-between">
                    <div class="mb-6 md:mb-0 md:mr-8">
                        ...
                        <p class="text-gray-600 max-w-2xl">Kami memiliki ribuan produk konstruksi yang mungkin tidak
                            ...
                            <span class="font-semibold text-[#99765c]">Pasti tersedia!</span></p>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', setting('contact.whatsapp')) }}?text=Halo, saya mencari produk yang tidak ada di katalog. Bisakah Anda membantu?"
                            target="_blank"
