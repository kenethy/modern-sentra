...
<div class="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-8">
                ...
                <div class="fade-in" style="animation-delay: 0.1s;">
                    <div class="product-gallery-main" id="mainImage">
                        @if($product->hasMedia('product_images'))
                            <img src="{{ $product->getFirstMediaUrl('product_images') }}" alt="{{ $product->name }}" class="gallery-main-img">
                        @else
                        ...
                        <!-- Zoom Icon -->
                        <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-0 hover:bg-opacity-30 transition-all duration-300 cursor-pointer" onclick="openLightbox(0)">
                ...
                <div class="fade-in" style="animation-delay: 0.2s;">
                    ...
                    <div class="mt-8 space-y-4">
                        <a href="{{ route('quote-request.product', ['id' => $product->id]) }}" class="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 bg-[#99765c] text-white font-medium rounded-lg shadow-md hover:bg-[#876754] transition duration-300 transform hover:scale-105">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', setting('contact.whatsapp')) }}?text=Halo, saya tertarik dengan produk {{ $product->name }}. Bisakah Anda memberikan informasi lebih lanjut?" target="_blank" class="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-medium rounded-lg shadow-md hover:bg-green-700 transition duration-300 transform hover:scale-105">
                    ...
                    <div id="details" class="tab-content active">
                        <div class="prose max-w-none">
                            ...
                            @if($product->details)
                                {!! $product->details !!}
                            @else
                                <p>{{ $product->name }} adalah produk berkualitas tinggi yang dirancang untuk memenuhi kebutuhan proyek konstruksi Anda. Produk ini memiliki daya tahan yang baik dan mudah diaplikasikan.</p>
                                
                                <p>Untuk informasi lebih lanjut tentang produk ini, silakan hubungi tim kami melalui tombol "Minta Penawaran Harga" atau "Tanya via WhatsApp".</p>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="product-attributes">
                            ...
                            @else
                                <div class="col-span-full">
                                    <p class="text-gray-500 italic">Spesifikasi detail belum tersedia untuk produk ini. Silakan hubungi kami untuk informasi lebih lanjut.</p>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="related-product-card bg-white shadow-md overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex justify-between items-center">
                                    <a href="{{ route('products.show', $relatedProduct) }}" class="text-[#99765c] font-medium hover:underline">
                                        Lihat Detail
                                    </a>
                                    
                                    <a href="{{ route('quote-request.product', ['id' => $relatedProduct->id]) }}" class="text-xs bg-[#99765c] hover:bg-[#876754] text-white font-medium py-1 px-3 rounded-lg transition duration-300">
                                        Minta Penawaran
                                    </a>
                                </div>
                            </div>
        ...
        <div class="text-center fade-in" style="animation-delay: 0.5s;">
            <a href="{{ route('products.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
