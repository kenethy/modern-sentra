    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-12">
            <div class="flex flex-col md:flex-row">
                ...
                <div class="md:w-2/5 p-6 md:p-8 border-r border-gray-100">
                    <div class="product-gallery">
                        ...
                        <div class="mt-8 space-y-4">
                            <a href="{{ route('quote-request.product', ['id' => $product->id]) }}"
                                class="w-full inline-flex items-center justify-center px-6 py-3 bg-gray-800 text-white font-medium rounded-md shadow-md hover:bg-gray-700 transition duration-300">
                            ...
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', setting('contact.whatsapp', '6281234567890')) }}?text=Halo, saya tertarik dengan produk {{ $product->name }}. Bisakah Anda memberikan informasi lebih lanjut?"
                                target="_blank"
                                class="w-full inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-medium rounded-md shadow-md hover:bg-green-700 transition duration-300">
