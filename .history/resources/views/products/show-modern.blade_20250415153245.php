        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-8">
                ...
                <div class="product-gallery">
                    <div class="product-gallery-main group relative" id="mainImage">
                        ...
                        <!-- Zoom Icon -->
                        <div class="absolute inset-0 flex items-center justify-center bg-transparent hover:bg-black hover:bg-opacity-20 transition-all duration-300 cursor-pointer"
                            onclick="openLightbox(0)">
                            <div
                                class="bg-white bg-opacity-80 p-2 rounded-full shadow-lg transform scale-0 group-hover:scale-100 transition-transform duration-300">
                ...
                <div class="product-info">
                    <div class="flex items-center mb-4">
                        ...
                        <span
                            class="bg-amber-500 text-white text-xs font-semibold px-3 py-1.5 rounded-md shadow-sm ml-2">Produk
                            Unggulan</span>
                        @endif
                    </div>
                    ...
                    <div class="mt-8 space-y-4">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', setting('contact.whatsapp', '6281234567890')) }}?text=Halo, saya tertarik dengan produk {{ $product->name }}. Bisakah Anda memberikan informasi lebih lanjut?"
                            target="_blank"
                            class="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-medium rounded-md shadow-md hover:bg-green-700 transition duration-300">
            ...
            <div class="border-t border-gray-200 px-6 md:px-8 py-8 space-y-12">
                ...
                <div class="product-info-section">
                    <div class="flex items-center mb-6">
                        ...
                        <h2 class="text-2xl font-bold text-gray-900">Spesifikasi</h2>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                        <div class="product-attributes">
                            ...
                            <div class="col-span-full flex items-center p-4 bg-gray-50 rounded-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gray-400 mr-3" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                ...
                <div class="product-info-section">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 prose max-w-none">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div class="bg-gray-50 p-4 rounded-lg flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Ideal untuk bangunan perkantoran, pusat
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Cocok untuk rumah tinggal, apartemen, dan
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">Dapat digunakan untuk jembatan, jalan, dan
                            ...
                            <p class="mt-6 text-gray-700">Untuk informasi lebih lanjut tentang aplikasi produk ini,
