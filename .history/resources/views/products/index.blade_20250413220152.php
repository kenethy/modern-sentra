                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('quote-request.product', ['id' => $product->id]) }}"
                                class="bg-[#99765c] hover:bg-[#876754] text-white text-sm font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-300 transform hover:scale-105 inline-flex items-center justify-center">
