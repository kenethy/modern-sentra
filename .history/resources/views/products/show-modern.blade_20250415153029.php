...
<div class="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-12">
            ...
            <div class="border-t border-gray-200 px-6 md:px-8 py-6">
                <div class="flex border-b border-gray-200 bg-white">
                    <button class="tab-button active" data-tab="details">Detail Produk</button>
        ...
        <div class="text-center">
            <a href="{{ route('products.index') }}"
                class="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition duration-300 focus:outline-none focus:ring-2 focus:ring-gray-300">
