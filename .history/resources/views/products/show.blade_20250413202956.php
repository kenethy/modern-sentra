                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div>
                        ...
                        <div class="mb-4 relative group">
                            ...
                            <!-- Zoom icon on hover -->
                            <div
                                class="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 flex items-center justify-center transition-all duration-300 rounded-lg pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-12 w-12 text-white opacity-0 group-hover:opacity-80 transition-opacity duration-300"
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            ...
                            <div
                                class="thumbnail-item cursor-pointer border-2 border-transparent hover:border-blue-500 rounded-md overflow-hidden transition">
                        ...
                        <div
                            class="w-full h-80 md:h-96 bg-gray-200 rounded-lg flex items-center justify-center text-gray-400">
                        ...
                        <div id="lightbox"
                            ...
                            <div class="relative max-w-4xl max-h-full">
                                ...
                                <button onclick="closeLightbox()"
                                    class="absolute top-2 right-2 md:-top-4 md:-right-4 bg-gray-800 bg-opacity-50 text-white rounded-full p-2 hover:bg-opacity-75 transition">
                    ...
                    <div>
                        <div class="flex justify-between items-start mb-3">
                            ...
                            @if($product->category)
                            <span
                                class="bg-blue-100 text-blue-800 text-sm font-semibold px-2.5 py-0.5 rounded-full whitespace-nowrap">
                        ...
                        <div class="mt-8 flex flex-wrap gap-4">
                            ...
                            <a href="{{ route('quote-request.product', ['id' => $product->id]) }}"
                                class="inline-flex items-center justify-center bg-[#99765c] hover:bg-[#876754] text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#99765c] focus:ring-offset-2 transition duration-300 shadow-md hover:shadow-lg">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-6 lg:p-8 bg-white border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div
                        class="group bg-white rounded-lg overflow-hidden border border-gray-200 hover:shadow-lg transition duration-300">
                        <a href="{{ route('products.show', $related->slug) }}" class="block">
                            ...
                            <div class="p-4">
                                <h3
                                    class="text-lg font-semibold text-gray-800 mb-1 group-hover:text-blue-600 transition-colors">
                                    {{ $related->name }}</h3>
                                <p class="text-sm text-gray-600 mb-3 line-clamp-2">{{
                                    Str::limit(strip_tags($related->description ?? ''), 80) }}</p>
                                <span
