...
<div class="bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="md:w-2/5 p-4 md:p-6 lg:p-8">
                    @php
                        ...
                        } elseif ($product->getFirstMediaUrl('product_images')) { // Handle case where there's only one image but not in a collection loop
                            $imageUrls[] = $product->getFirstMediaUrl('product_images');
                        } else {
                            $imageUrls[] = asset('images/placeholder.jpg'); // Default placeholder
                        }
                    @endphp
                    <div class="product-gallery sticky top-4">
                        {{-- Add data attribute to hold image URLs --}}
                        <div class="product-gallery-main group relative rounded-lg overflow-hidden" id="mainImage" data-images="{{ json_encode($imageUrls) }}">
                            @if($product->hasMedia('product_images'))
                ...
                <div class="md:w-3/5 p-4 md:p-6 lg:p-8 bg-gray-50 md:bg-white">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-gray-800 px-4 py-3 flex items-center">
                                ...
                                <h2 class="text-lg font-bold text-white">Detail Produk</h2>
                            </div>
                        ...
                        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-gray-800 px-4 py-3 flex items-center">
                                ...
                                <h2 class="text-lg font-bold text-white">Spesifikasi</h2>
                            </div>
                        ...
                        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-gray-800 px-4 py-3 flex items-center">
                                ...
                                <h2 class="text-lg font-bold text-white">Aplikasi</h2>
                            </div>
                            ...
                            <div class="p-4 md:p-5">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <p class="mt-4 text-gray-700">Untuk informasi lebih lanjut tentang aplikasi produk
                                        ini, silakan hubungi tim kami.</p>
                                </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="mt-12"> {{-- Changed mb-12 to mt-12 and moved inside --}}
                    ...
                    <!-- Back to Products -->
                    <div class="mt-8 text-center"> {{-- Changed margin and moved inside --}}
                        <a href="{{ route('products.index') }}"
        ...
        </div> {{-- End of bg-white rounded-xl --}}
        ...
        {{-- Removed php block from here --}}

        {{-- Removed intermediate script tag --}}
        @push('scripts')
        <script>
            ...
            let images = []; // Initialize empty array

            document.addEventListener('DOMContentLoaded', function () {
                // Get images from data attribute after DOM is loaded
                const mainImageContainer = document.getElementById('mainImage');
                if (mainImageContainer && mainImageContainer.dataset.images) {
                    try {
                        images = JSON.parse(mainImageContainer.dataset.images);
                    } catch (e) {
                        console.error("Error parsing image data:", e);
                        images = ["{{ asset('images/placeholder.jpg') }}"]; // Fallback
                    }
                } else {
                     images = ["{{ asset('images/placeholder.jpg') }}"]; // Fallback if attribute not found
                }
