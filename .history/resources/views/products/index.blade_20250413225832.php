        ...
        <div class="max-w-lg">
            ...
            <div class="flex space-x-4">
                <a href="#product-catalog"
                    class="bg-gradient-to-r from-[#99765c] to-[#d17a46] hover:from-[#876754] hover:to-[#e6a585] text-white font-bold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 inline-flex items-center">
                    Jelajahi Produk
                ...
                <a href="{{ route('quote-request.create') }}"
                    class="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#4a6741] font-bold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
                    Minta Penawaran
                </a>
            </div>
        </div>
            ...
            <div class="bg-white filter-container p-6 shadow-lg">
                ...
                <form action="{{ route('products.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-end space-x-3">
                        <button type="submit"
                            class="bg-[#4a6741] hover:bg-[#6b8a61] text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline transition duration-300 filter-button flex-grow md:flex-grow-0">
                ...
                <div class="product-card bg-white stagger-item" style="animation-delay: {{ $index * 0.1 }}s;">
                    <div class="product-image-container">
                        ...
                        <div class="absolute top-4 right-4">
                            <span
                                class="category-badge category-badge-{{ ($product->category->id % 4) + 1 }} bg-opacity-90 text-white text-xs font-bold px-3 py-1.5 rounded-full">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('quote-request.product', ['id' => $product->id]) }}"
                                class="bg-[#99765c] hover:bg-[#876754] text-white text-sm font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-300 transform hover:scale-105 inline-flex items-center justify-center quote-button">
