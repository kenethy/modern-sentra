            ...
            <div id="location" class="fade-in delay-2 contact-column">
                ...
                <div class="mt-4 bg-white p-5 rounded-md shadow-sm flex-grow">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="https://www.google.com/maps/search/?api=1&query={{ $contactInfo['address_encoded'] }}"
                            target="_blank"
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100">
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-100">
                            <a href="https://www.google.com/maps/dir/?api=1&destination={{ $contactInfo['address_encoded'] }}"
                                target="_blank"
