...
<style>
    ...
    /* Enhanced brown palette text styles */
    .enhanced-heading {
        color: #c69c6d;
...
<section
    ...
    <div class="relative z-10 container mx-auto px-6 max-w-3xl" data-observe>
        <h1
            class="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-5 leading-tight animate-fadeInUp enhanced-heading">
            Material Konstruksi Pilihan Anda
        </h1>
        <p class="text-lg md:text-xl mb-10 animate-fadeInUp delay-100 bright-tagline">
            <span class="modern-text">Modern</span> <span class="sentra-text">Sentra</span>: Solusi lengkap bahan
            bangunan <span class="highlight-text">berkualitas</span> untuk proyek Anda di Sidoarjo.
        </p>
        <div class="flex flex-col sm:flex-row justify-center items-center gap-4 animate-fadeInUp delay-200">
            <a href="{{ route('products.index') }}"
                class="inline-flex items-center justify-center bg-[#c69c6d] hover:bg-[#b07d4a] text-white font-semibold py-3 px-8 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#c69c6d] focus:ring-offset-2 focus:ring-offset-black w-full sm:w-auto">
                Jelajahi Produk
    ...
    <div class="container mx-auto px-6 space-y-20 sm:space-y-24 lg:space-y-32">
        ...
        <section data-observe>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                {{-- Feature Card 1 --}}
                <div
                    class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-[#99765c]/30 transition-all duration-300 ease-in-out text-center animate-fadeInUp delay-100 group">
                    <div class="flex justify-center mb-6">
                        <div
                            class="bg-[#f5f2ef] p-4 rounded-full transition-colors duration-300 group-hover:bg-[#99765c]/10">
                            {{-- Heroicon: ShieldCheckIcon --}}
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-10 w-10 text-[#99765c] transition-transform duration-300 group-hover:scale-110"
                ...
                {{-- Feature Card 2 --}}
                <div
                    class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-[#99765c]/30 transition-all duration-300 ease-in-out text-center animate-fadeInUp delay-200 group">
                    <div class="flex justify-center mb-6">
                        <div
                            class="bg-[#f5f2ef] p-4 rounded-full transition-colors duration-300 group-hover:bg-[#99765c]/10">
                ...
                {{-- Feature Card 3 --}}
                <div
                    class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-[#99765c]/30 transition-all duration-300 ease-in-out text-center animate-fadeInUp delay-300 group">
                    <div class="flex justify-center mb-6">
                        <div
                            class="bg-[#f5f2ef] p-4 rounded-full transition-colors duration-300 group-hover:bg-[#99765c]/10">
        ...
        {{-- Partner Section --}}
        <section data-observe>
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-16 animate-fadeInUp">Partner
                Terpercaya Kami</h2>
            <div
                class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-x-8 gap-y-10 items-center justify-center">
                ...
                <div class="flex justify-center animate-fadeInUp" style="animation-delay: {{ ($index + 1) * 0.08 }}s;">
                    ...
                    <svg class="h-12 w-auto text-gray-400 hover:text-gray-600 transition-colors duration-300"
                        fill="currentColor" viewBox="0 0 120 40" xmlns="http://www.w3.org/2000/svg">
                        <rect width="120" height="40" fill="#e5e7eb" />
                        <text x="60" y="25" font-family="sans-serif" font-size="10" text-anchor="middle"
                            fill="#6b7280">{{ $partnerName }}</text>
                    </svg>
                    {{-- <img src="https://via.placeholder.com/150x50/E5E7EB/6B7280?text={{ urlencode($partnerName) }}"
                        alt="{{ $partnerName }}"
        ...
        <section data-observe>
            <div
                class="bg-gradient-to-r from-[#b07d4a] to-[#8c6239] rounded-2xl overflow-hidden shadow-lg animate-fadeInUp">
                <div class="px-8 py-12 md:p-16 lg:flex lg:items-center lg:justify-between">
                    <div class="lg:w-0 lg:flex-1 mb-10 lg:mb-0 text-center lg:text-left">
                        <h2 class="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight enhanced-heading">Siap
                            Memulai Proyek Anda?</h2>
                        <p class="text-[#e6d2b5] text-lg mb-8 max-w-2xl mx-auto lg:mx-0">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                            <a href="/contact" {{-- Ganti dengan route('contact') jika ada --}}
                                class="inline-flex items-center justify-center bg-white text-[#b07d4a] hover:bg-gray-100 font-semibold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#b07d4a] w-full sm:w-auto">
                                Hubungi Kami
                            ...
                            <a href="{{ route('quote-request.create') }}"
                                class="inline-flex items-center justify-center bg-[#d4a76a] hover:bg-[#c69c6d] text-white font-semibold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#d4a76a] focus:ring-offset-2 focus:ring-offset-[#b07d4a] w-full sm:w-auto">
