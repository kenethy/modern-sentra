                ...
                <div class="form-container bg-white p-6 rounded-md shadow-sm">
                    ...
                    <form id="contactForm" class="flex-grow flex flex-col" onsubmit="sendWhatsAppMessage(event)">
                        ...
                        <div class="mt-auto flex gap-3">
                            <button type="submit"
                                class="submit-button flex-1 bg-[#4a6741] hover:bg-[#6b8a61] text-white font-medium py-2 px-4 rounded-md transition duration-300 inline-flex items-center justify-center">
                                <span>Kirim Pesan</span>
