    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <section class="mb-20 animate-on-scroll">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Stat Card 1 -->
                <div
                    class="stat-card bg-gradient-to-br from-[#f5f2ef] to-[#e8ddd5] p-6 rounded-xl shadow-md text-center">
                    <div class="bg-[#99765c] rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <h3 class="text-4xl font-bold text-[#99765c] mb-2">5,000+</h3>
                ...
                <div
                    ...
                    <h3 class="text-4xl font-bold text-[#99765c] mb-2">1,200+</h3>
                ...
                <div
                    ...
                    <h3 class="text-4xl font-bold text-[#99765c] mb-2">50+</h3>
