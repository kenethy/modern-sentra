            ...
            <div class="contact-card p-5 fade-in delay-1">
                <div class="flex items-start">
                    <div class="bg-[#99765c] bg-opacity-10 p-2 rounded-full mr-3 flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 contact-icon" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div>
                        ...
                        <a href="https://maps.google.com/?q={{ $contactInfo['coordinates'] }}" target="_blank"
            ...
            <div class="contact-card p-5 fade-in delay-2">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <button type="button"
                            class="copy-button text-xs text-[#99765c] hover:text-[#876754] inline-flex items-center"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div id="contact-form" class="fade-in delay-1 contact-column">
                <div class="form-container bg-white p-6 rounded-md shadow-sm">
                    ...
                    <form id="contactForm" action="#" method="POST" class="flex-grow flex flex-col">
                        ...
                        <div class="mt-auto">
                            <button type="submit"
                                class="submit-button bg-[#99765c] hover:bg-[#876754] text-white font-medium py-2 px-4 rounded-md transition duration-300 inline-flex items-center justify-center">
                                <span>Kirim Pesan</span>
            ...
            <div id="location" class="fade-in delay-2 contact-column">
                <div class="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.4147393854403!2d{{ $contactInfo['longitude'] }}!3d{{ $contactInfo['latitude'] }}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zN8KwMjYnNTIuMSJTIDExMsKwNDMnMDUuOSJF!5e0!3m2!1sen!2sid!4v1650123456789!5m2!1sen!2sid&q={{ $contactInfo['address_encoded'] }}"
                ...
                <div class="mt-4 bg-white p-5 rounded-md shadow-sm flex-grow">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="https://www.google.com/maps/search/?api=1&query={{ $contactInfo['coordinates'] }}"
                            target="_blank"
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100">
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-100">
                            <a href="https://www.google.com/maps/dir/?api=1&destination={{ $contactInfo['coordinates'] }}"
                                target="_blank"
