        ...
        <div class="contact-hero mb-10 fade-in">
            <div class="py-10 px-6 md:py-12 md:px-10 text-center">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    <a href="#location"
                        class="inline-flex items-center justify-center px-5 py-2 bg-transparent border border-white text-white font-medium rounded-md hover:bg-white hover:text-[#d17a46] transition duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5 flex-shrink-0" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
