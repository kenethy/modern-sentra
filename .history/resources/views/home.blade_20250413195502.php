...
<div class="relative bg-white overflow-hidden">
    <div class="hero-section bg-cover bg-center h-screen flex items-center"
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-lg">
                <h1 class="text-5xl md:text-6xl font-bold text-white mb-6 hero-text">Material Konstruksi Pilihan Anda
                </h1>
                <p class="text-xl text-white mb-10 opacity-90">Modern Sentra: Solusi lengkap bahan bangunan berkualitas
                    untuk proyek Anda di Sidoarjo.</p>
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('products.index') }}"
                        class="bg-[#99765c] hover:bg-[#876754] text-white font-bold py-3 px-8 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 inline-flex items-center">
                        Lihat Produk
                    ...
                    <a href="{{ route('quote-request.create') }}"
                        class="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#99765c] font-bold py-3 px-8 rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
                        Minta Penawaran
                    </a>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-20 fade-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div class="feature-card bg-white p-8 text-center rounded-xl shadow-md stagger-item">
                    <div class="flex justify-center mb-6">
                        <div class="feature-icon bg-[#99765c] bg-opacity-10 p-4 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-[#99765c]" fill="none"
                    ...
                    <p class="text-gray-600">Kami hanya menyediakan produk berkualitas tinggi dari merek terpercaya
                        untuk memastikan keberhasilan proyek Anda.</p>
                </div>
                ...
                <div class="feature-card bg-white p-8 text-center rounded-xl shadow-md stagger-item"
                    ...
                    <p class="text-gray-600">Dapatkan material konstruksi berkualitas dengan harga yang bersaing dan
                        transparansi penuh dalam setiap penawaran.</p>
                </div>
                ...
                <div class="feature-card bg-white p-8 text-center rounded-xl shadow-md stagger-item"
                    ...
                    <p class="text-gray-600">Tim profesional kami siap membantu Anda menemukan solusi material yang
                        tepat untuk kebutuhan proyek Anda.</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-20 fade-in">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <a href="{{ route('products.show', $product->slug) }}"
                                class="detail-button text-[#99765c] hover:text-[#876754] font-medium inline-flex items-center">
                                Lihat Detail
            ...
            <div class="text-center mt-12">
                <a href="{{ route('products.index') }}"
                    class="inline-block bg-[#99765c] hover:bg-[#876754] text-white font-bold py-3 px-8 rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
                    Lihat Semua Produk
                </a>
            </div>
        </div>
        ...
        <div class="mb-20 fade-in">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
                <div class="flex justify-center stagger-item">
                    <img src="https://via.placeholder.com/150x60/F5F5F5/99765c?text=PARTNER+1" alt="Partner 1"
                        class="h-12 opacity-70 hover:opacity-100 transition duration-300">
                </div>
                <div class="flex justify-center stagger-item" style="animation-delay: 0.1s;">
                    <img src="https://via.placeholder.com/150x60/F5F5F5/99765c?text=PARTNER+2" alt="Partner 2"
                        class="h-12 opacity-70 hover:opacity-100 transition duration-300">
                </div>
                <div class="flex justify-center stagger-item" style="animation-delay: 0.2s;">
                    <img src="https://via.placeholder.com/150x60/F5F5F5/99765c?text=PARTNER+3" alt="Partner 3"
                        class="h-12 opacity-70 hover:opacity-100 transition duration-300">
                </div>
                <div class="flex justify-center stagger-item" style="animation-delay: 0.3s;">
                    <img src="https://via.placeholder.com/150x60/F5F5F5/99765c?text=PARTNER+4" alt="Partner 4"
                        class="h-12 opacity-70 hover:opacity-100 transition duration-300">
                </div>
                <div class="flex justify-center stagger-item" style="animation-delay: 0.4s;">
                    <img src="https://via.placeholder.com/150x60/F5F5F5/99765c?text=PARTNER+5" alt="Partner 5"
                        class="h-12 opacity-70 hover:opacity-100 transition duration-300">
                </div>
                <div class="flex justify-center stagger-item" style="animation-delay: 0.5s;">
                    <img src="https://via.placeholder.com/150x60/F5F5F5/99765c?text=PARTNER+6" alt="Partner 6"
                        class="h-12 opacity-70 hover:opacity-100 transition duration-300">
                </div>
            </div>
        </div>
