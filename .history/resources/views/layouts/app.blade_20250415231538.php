        ...
        <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            <a href="{{ route('home') }}" class="flex items-center">
                                <img src="{{ asset('images/logo/logo.png') }}" alt="Modern Sentra Logo"
                                    class="store-logo mr-2">
                                <span class="font-bold text-xl logo-text">
                                    <span class="logo-modern">MODERN</span> <span class="logo-sentra">SENTRA</span>
                                </span>
                            </a>
                        </div>
            ...
            <div class="hidden sm:hidden">
                ...
                <div class="flex items-center justify-center py-3 border-b border-gray-200">
                    <a href="{{ route('home') }}" class="flex items-center">
                        <img src="{{ asset('images/logo/placeholder-logo.svg') }}" alt="Modern Sentra Logo"
                            class="store-logo-mobile mr-2">
                        <span class="font-bold text-lg logo-text">
                            <span class="logo-modern">MODERN</span> <span class="logo-sentra">SENTRA</span>
                        </span>
                    </a>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="col-span-1 md:col-span-1">
                        <h3 style="color:white" class="text-lg font-bold mb-4">Modern Sentra</h3>
                    ...
                    <div class="col-span-1">
                        <h3 style="color:white" class="text-lg font-bold mb-4">Tautan Cepat</h3>
                        <ul class="space-y-2">
                    ...
                    <!-- Products -->
                    <div class="col-span-1">
                        <h3 style="color:white" class="text-lg text-white font-bold mb-4">Kategori Produk</h3>
                        <ul class="space-y-2">
                    ...
                    <!-- Contact Info -->
                    <div class="col-span-1">
                        <h3 style="color:white" class="text-lg font-bold mb-4">Kontak Kami</h3>
                        <ul class="space-y-2">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-400">Jl. Sarirogo No.8, Sari Rogo, Kec. Sidoarjo, Kabupaten Sidoarjo, Jawa Timur 61234</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-6 w-6 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                ...
                                <span class="text-gray-400">+62 877-5289-5532</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-6 w-6 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                            ...
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-400">Senin - Sabtu: 08:30 - 17:00</span>
                            </li>
                        </ul>
                    </div>
                </div>
