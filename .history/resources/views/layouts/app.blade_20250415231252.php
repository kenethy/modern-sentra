                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="col-span-1 md:col-span-1">
                        <div class="flex items-center mb-4">
                            <img src="{{ asset('images/logo/logo.png') }}" alt="Modern Sentra Logo" class="store-logo-footer mr-2">
                            <span class="font-bold text-lg logo-text">
                                <span class="logo-modern text-white">MODERN</span> <span class="logo-sentra">SENTRA</span>
                            </span>
                        </div>
