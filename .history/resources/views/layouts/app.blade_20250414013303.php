                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        <div class="shrink-0 flex items-center">
                            <a href="{{ route('home') }}" class="font-bold text-xl logo-text">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div class="col-span-1 md:col-span-1">
                        <h3 class="text-lg font-bold mb-4 text-white">Modern Sentra</h3> <p class="text-gray-400 mb-4">Supplier bahan bangunan berkualitas untuk proyek konstruksi Anda.
                        </p>
                    ...
                    <div class="col-span-1">
                         <h3 class="text-lg font-bold mb-4 text-white">Kategori Produk</h3>
                        <ul class="space-y-2">
                    ...
                    <div class="col-span-1">
                        <h3 class="text-lg font-bold mb-4 text-white">Kontak Kami</h3>
                        <ul class="space-y-2">
                            <li class="flex items-start">
                                <svg class="h-6 w-6 text-gray-400 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
