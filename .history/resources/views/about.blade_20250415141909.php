    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <section class="mb-20 animate-on-scroll">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Vision Card -->
                <div
                    class="bg-gradient-to-br from-[#f5f2ef] to-[#e8ddd5] p-8 rounded-xl shadow-lg transform transition duration-500 hover:scale-105">
                    <div class="flex items-center mb-6">
                        <div class="bg-[#99765c] p-3 rounded-full mr-4">
                        ...
                        <h3 class="text-2xl font-bold text-[#99765c]">Visi</h3>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-[#99765c]">Misi</h3>
                    </div>
                    <div class="text-gray-700 text-lg leading-relaxed">
                        {!! nl2br(e($mission)) !!}
                    </div>
