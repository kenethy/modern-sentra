...
<section
    ...
    <div class="relative z-10 container mx-auto px-6 max-w-3xl" data-observe>
        <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-5 leading-tight animate-fadeInUp gradient-text">
            Material Konstruksi Pilihan Anda
        </h1>
        <p class="text-lg md:text-xl mb-10 animate-fadeInUp delay-100 bright-text">
        ...
        <div class="flex flex-col sm:flex-row justify-center items-center gap-4 animate-fadeInUp delay-200">
            <a href="{{ route('products.index') }}"
                class="inline-flex items-center justify-center bg-[#FF6B6B] hover:bg-[#FF5252] text-white font-semibold py-3 px-8 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#FF6B6B] focus:ring-offset-2 focus:ring-offset-black w-full sm:w-auto">
                Jelajahi Produk
...
<div class="bg-gray-50 py-20 sm:py-24 lg:py-32">
    <div class="container mx-auto px-6 space-y-20 sm:space-y-24 lg:space-y-32">
        ...
        <section data-observe>
            <div
                class="bg-gradient-to-r from-[#118AB2] to-[#073B4C] rounded-2xl overflow-hidden shadow-lg animate-fadeInUp">
                <div class="px-8 py-12 md:p-16 lg:flex lg:items-center lg:justify-between">
                    <div class="lg:w-0 lg:flex-1 mb-10 lg:mb-0 text-center lg:text-left">
                        <h2 class="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight gradient-text">Siap
                            Memulai Proyek Anda?</h2>
                        <p class="text-[#FFD166] text-lg mb-8 max-w-2xl mx-auto lg:mx-0">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                            <a href="/contact" {{-- Ganti dengan route('contact') jika ada --}}
                                class="inline-flex items-center justify-center bg-white text-[#118AB2] hover:bg-gray-100 font-semibold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#118AB2] w-full sm:w-auto">
                                Hubungi Kami
                            ...
                            <a href="{{ route('quote-request.create') }}"
                                class="inline-flex items-center justify-center bg-[#FF6B6B] hover:bg-[#FF5252] text-white font-semibold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#FF6B6B] focus:ring-offset-2 focus:ring-offset-[#118AB2] w-full sm:w-auto">
