...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function initProductSelection() {
            ...
            if ({{ isset($selectedProduct) && $selectedProduct ? 'true' : 'false' }
        }) {
        const productId = '{{ isset($selectedProduct) && $selectedProduct ? $selectedProduct->id : '' }}';
        const productName = '{{ isset($selectedProduct) && $selectedProduct ? $selectedProduct->name : '' }}';
