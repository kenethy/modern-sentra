...
<div class="py-12 bg-var(--bg-light)">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('products.show', $product->slug) }}"
                            class="ml-1 text-gray-500 hover:text-[#99765c] md:ml-2">{{ $product->name }}</a>
                    </div>
                </li>
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">Isi formulir di bawah untuk mendapatkan penawaran harga terbaik
                untuk produk yang Anda pilih.</p>
        </div>
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('quote-request.create', ['product_id' => $product->id]) }}"
                            class="inline-flex items-center text-[#99765c] hover:text-[#876754] font-medium text-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="md:col-span-2 p-4">
                                <div class="flex items-center mb-2">
                                    <span class="bg-[#99765c] text-white text-xs font-semibold px-2 py-1 rounded-md">{{
                                        $product->category->name }}</span>
                                    @if($product->is_featured)
                                    <span
                                        class="bg-amber-500 text-white text-xs font-semibold px-2 py-1 rounded-md ml-2">Produk
                                        Unggulan</span>
                                    @endif
                                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" id="name" name="name" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#99765c] focus:border-transparent">
                        </div>
                    ...
                    <div class="flex items-center mb-4">
                        <input type="checkbox" id="terms" name="terms" required
                            class="h-4 w-4 text-[#99765c] focus:ring-[#99765c] border-gray-300 rounded">
                        <label for="terms" class="ml-2 block text-sm text-gray-700">
                            Saya setuju bahwa data saya akan diproses sesuai dengan <a href="#"
                                class="text-[#99765c] hover:underline">Kebijakan Privasi</a>.
                        </label>
                    </div>

                    <div class="flex justify-end">
                        <button type="submit"
                            class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-[#99765c] hover:bg-[#876754] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#99765c]">
