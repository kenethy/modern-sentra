...
<div class="py-12 bg-gray-50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-10">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto mb-6">Isi formulir di bawah untuk mendapatkan penawaran harga
                terbaik untuk produk yang Anda pilih.</p>
            ...
            <form id="quoteForm" action="{{ route('quote-request.store') }}" method="POST">
                ...
                <div class="mb-8">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('quote-request.create') }}"
                            class="text-[#99765c] hover:text-[#876754] font-medium inline-flex items-center">
                ...
                <div class="mt-10">
                    ...
                    <div class="mt-8 pt-4 border-t border-gray-200">
                        <button type="submit"
                            class="px-6 py-3 bg-[#99765c] text-white rounded-lg hover:bg-[#876754] transition duration-300 shadow-md">
                            Kirim Permintaan
                        </button>
                    </div>
                </div>
