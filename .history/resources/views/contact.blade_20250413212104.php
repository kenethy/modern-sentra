...
<div class="py-16 bg-gray-50 contact-section">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16 animate-on-scroll">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">Kami siap membantu Anda dengan kebutuhan bahan bangunan
                untuk proyek Anda. Jangan ragu untuk menghubungi kami.</p>
        </div>
