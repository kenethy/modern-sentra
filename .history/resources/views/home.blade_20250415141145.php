...
{{-- Hero Section --}}
<section class="relative h-screen flex items-center justify-center text-center bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-6 max-w-3xl" data-observe>
        <h1 style="color:white" class="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-5 leading-tight animate-fadeInUp">
            Material Konstruksi Pilihan Anda
        </h1>
        <p class="text-lg md:text-xl text-gray-300 mb-10 animate-fadeInUp delay-100">
...
<div class="bg-gray-50 py-20 sm:py-24 lg:py-32">
    <div class="container mx-auto px-6 space-y-20 sm:space-y-24 lg:space-y-32">
        ...
        <section data-observe>
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-16 animate-fadeInUp">Mengapa Memilih Modern Sentra</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                {{-- Feature Card 1 --}}
                <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-[#99765c]/30 transition-all duration-300 ease-in-out text-center animate-fadeInUp delay-100 group">
                    <div class="flex justify-center mb-6">
                        <div class="bg-[#f5f2ef] p-4 rounded-full transition-colors duration-300 group-hover:bg-[#99765c]/10">
                            {{-- Heroicon: ShieldCheckIcon --}}
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-[#99765c] transition-transform duration-300 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                        </div>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Kualitas Terjamin</h3>
                    <p class="text-gray-600 leading-relaxed">Produk dari merek terpercaya untuk memastikan daya tahan dan hasil terbaik proyek Anda.</p>
                </div>
                 {{-- Feature Card 2 --}}
                <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-[#99765c]/30 transition-all duration-300 ease-in-out text-center animate-fadeInUp delay-200 group">
                    <div class="flex justify-center mb-6">
                        <div class="bg-[#f5f2ef] p-4 rounded-full transition-colors duration-300 group-hover:bg-[#99765c]/10">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Harga Kompetitif</h3>
                    <p class="text-gray-600 leading-relaxed">Penawaran terbaik untuk material berkualitas tinggi, transparan dan tanpa biaya tersembunyi.</p>
                </div>
                 {{-- Feature Card 3 --}}
                <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-[#99765c]/30 transition-all duration-300 ease-in-out text-center animate-fadeInUp delay-300 group">
                    <div class="flex justify-center mb-6">
                        <div class="bg-[#f5f2ef] p-4 rounded-full transition-colors duration-300 group-hover:bg-[#99765c]/10">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Konsultasi Ahli</h3>
                    <p class="text-gray-600 leading-relaxed">Tim kami siap membantu Anda memilih material yang paling sesuai dengan kebutuhan spesifik proyek.</p>
                </div>
            </div>
        </section>
        ...
        <section data-observe>
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-16 animate-fadeInUp">Produk Unggulan Kami</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($featuredProducts as $index => $product)
                <div class="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 group transition-all duration-300 ease-in-out hover:shadow-xl animate-fadeInUp" style="animation-delay: {{ ($index + 1) * 0.1 }}s;">
                    <a href="{{ route('products.show', $product->slug) }}" class="block">
                        <div class="relative aspect-w-4 aspect-h-3 overflow-hidden">
                            ...
                            <div class="absolute top-3 right-3">
                                <span class="bg-[#99765c]/90 text-white text-xs font-medium px-3 py-1 rounded-full shadow-sm">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-2 group-hover:text-[#99765c] transition-colors duration-200">
                            <a href="{{ route('products.show', $product->slug) }}">{{ $product->name }}</a>
                        </h3>
                        <p class="text-gray-600 text-sm mb-5 line-clamp-2">{{ Str::limit($product->description, 90) }}</p>
            ...
            <div class="text-center mt-16 animate-fadeInUp" style="animation-delay: {{ ($featuredProducts->count() + 1) * 0.1 }}s;">
                <a href="{{ route('products.index') }}"
        ...
        {{-- Partner Section --}}
        <section data-observe>
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-16 animate-fadeInUp">Partner Terpercaya Kami</h2>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-x-8 gap-y-10 items-center justify-center">
                {{-- Ganti src dengan logo asli atau gunakan placeholder SVG yang lebih baik --}}
                @php
                    $partners = ['PARTNER 1', 'PARTNER 2', 'PARTNER 3', 'PARTNER 4', 'PARTNER 5', 'PARTNER 6'];
                @endphp
                @foreach($partners as $index => $partnerName)
                <div class="flex justify-center animate-fadeInUp" style="animation-delay: {{ ($index + 1) * 0.08 }}s;">
                    {{-- Contoh Placeholder SVG (Ganti dengan <img src="logo.svg"> jika ada) --}}
                    <svg class="h-12 w-auto text-gray-400 hover:text-gray-600 transition-colors duration-300" fill="currentColor" viewBox="0 0 120 40" xmlns="http://www.w3.org/2000/svg">
                        <rect width="120" height="40" fill="#e5e7eb"/>
                        <text x="60" y="25" font-family="sans-serif" font-size="10" text-anchor="middle" fill="#6b7280">{{ $partnerName }}</text>
                    </svg>
                    {{-- <img src="https://via.placeholder.com/150x50/E5E7EB/6B7280?text={{ urlencode($partnerName) }}" alt="{{ $partnerName }}"
                         class="h-10 sm:h-12 object-contain filter grayscale hover:grayscale-0 transition duration-300 ease-in-out opacity-70 hover:opacity-100"> --}}
                </div>
                @endforeach
            </div>
        </section>
        ...
        <section data-observe>
            <div class="bg-gradient-to-r from-[#99765c] to-[#7d5e48] rounded-2xl overflow-hidden shadow-lg animate-fadeInUp">
                <div class="px-8 py-12 md:p-16 lg:flex lg:items-center lg:justify-between">
                    <div class="lg:w-0 lg:flex-1 mb-10 lg:mb-0 text-center lg:text-left">
                        <h2 class="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">Siap Memulai Proyek Anda?</h2>
                        <p class="text-[#f5f2ef] text-lg mb-8 max-w-2xl mx-auto lg:mx-0">
                            Hubungi tim kami sekarang untuk konsultasi gratis dan dapatkan penawaran khusus yang disesuaikan dengan kebutuhan proyek konstruksi Anda.
                        </p>
                    ...
                    <div class="hidden lg:block lg:w-1/3 flex-shrink-0 mt-10 lg:mt-0 lg:ml-12">
                        ...
                        <img src="https://images.unsplash.com/photo-1581092916389-95414b16f481?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80"
                             ...
                             class="rounded-lg shadow-xl object-cover w-full h-auto max-h-80">
                    </div>
                </div>
            </div>
        </section>
